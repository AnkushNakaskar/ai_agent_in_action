...
while True:
    ...
    fig.update_layout(
        title=f"Cosine Similarities of '{documents[selected_document_index][:50] + '...' if len(documents[selected_document_index]) > 50 else documents[selected_document_index]}' with Others",
